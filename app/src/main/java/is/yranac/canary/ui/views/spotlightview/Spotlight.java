...
public class Spotlight {
    ...
    private static final long DEFAULT_DURATION = 1400;
    ...
    public Spotlight setRepeatCount(int repeatCount) {
    ...
    public Spotlight setStartDelay(long startDelay) {
    ...
    public Spotlight setDirection(int direction) {
    ...
    public Spotlight setAnimatorListener(Animator.AnimatorListener animatorListener) {
        this.animatorListener = animatorListener;
        return this;
    }

    public <V extends View & SpotlightViewBase> void start(final V shimmerView) {
        ...
        if (!shimmerView.isSetUp()) {
            shimmerView.setAnimationSetupCallback(new SpotlightViewHelper.AnimationSetupCallback() {
                @Override
