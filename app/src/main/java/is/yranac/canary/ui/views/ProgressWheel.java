...
public class ProgressWheel extends View {
    ...
    private static final String LOG_TAG = "ProgressWheel";
    //Sizes (with defaults)
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.ProgressWheel_bar_width,
                barWidth);
        ...
        barLength = (int) a.getDimension(R.styleable.ProgressWheel_bar_length,
                barLength);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.i(LOG_TAG, text + ", " + String.valueOf(splitText.length));
