 ...
 * Created on 7/16/16.
 */
public class Pulsator extends RelativeLayout implements Animator.AnimatorListener {
    ...
    private void build() {
        ...
        for (int index = 0; index < mCount; index++) {
            ...
            // setup animators
            ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(pulseView, "ScaleX", 0.667f, 1f);
            scaleXAnimator.setRepeatMode(ObjectAnimator.RESTART);
            scaleXAnimator.setStartDelay(delay);
            animators.add(scaleXAnimator);

            ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(pulseView, "ScaleY", 0.667f, 1f);
            scaleYAnimator.setRepeatMode(ObjectAnimator.RESTART);
            scaleYAnimator.setStartDelay(delay);
            animators.add(scaleYAnimator);

            ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(pulseView, "Alpha", 0.667f, 0f);
        ...
        mAnimatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                mAnimatorSet.setStartDelay(700);
                mAnimatorSet.start();
            }
