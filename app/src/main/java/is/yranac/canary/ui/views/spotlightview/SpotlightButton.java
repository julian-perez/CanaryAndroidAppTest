 ...
 */
public class SpotlightButton extends Button implements SpotlightViewBase {

    private SpotlightViewHelper spotlightViewHelper;

    public SpotlightButton(Context context) {
        super(context);
        spotlightViewHelper = new SpotlightViewHelper(this, getPaint(), null);
        spotlightViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public SpotlightButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        spotlightViewHelper = new SpotlightViewHelper(this, getPaint(), attrs);
        spotlightViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public SpotlightButton(Context context, AttributeSet attrs, int defStyle) {
